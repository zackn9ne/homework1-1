...
function followed(event) {
    ...
    var response = "Thanks for following me, " + name + " @" + screenName + " ! " + soundcloud
    var soundcloud = "Checkout some of my music https://soundcloud.com/greater-glory-14"
        // Post that tweet!
...
function tweetEvent(tweet) {
    ...
    if (reply_to === 'selftwitterhandle') {
        ...
        var reply = "Yo @" + name + ' ' + ', Thanks for the mention :)';
